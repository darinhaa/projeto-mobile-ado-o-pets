...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" className="16" viewBox="0 0 20 16">
...
<ThemedText style={estilos.local}>Curitiba, Tatuquara</ThemedText>
<ThemedText style={estilos.data}>29/08/2025</ThemedText>
